...
const float c2 = 1.19557264e-03;
const float c1 = 8.39168489e-01;
const float c0 = 4.4135;
...
//                        distFitted = poly2d(distMean);
        ...
        //                distToDisp = distFitted/1000.0;
        //
        //                distToDAC = (distFitted >= VL53L1X_MAX_DISTANCE) ?
        //                        0 : DAC_MAX-((distFitted*DAC_MAX)/VL53L1X_MAX_DISTANCE);
//                    }
                }
            }
